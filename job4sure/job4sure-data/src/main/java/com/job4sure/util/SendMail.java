...
public class SendMail {
	...
	public static String mailSend(String email,String fullName,Integer registrationId, String autoGeneratedPassword) {
		try {
			...
			msg += " <br>";
		    msg += "http://localhost:7070/job4sure-web/verify?registrationId=" + autoGeneratedPassword;// used
			msg += " <br>";
			msg += "Regards,<br>";
			msg += "Job Portal";
