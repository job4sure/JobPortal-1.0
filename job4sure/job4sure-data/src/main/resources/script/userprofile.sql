...
insert into `userprofile` (`USERID`,`INDUSTRY`,`STATE`,`ADDRESS`,`CITY`,`CURRENT_LOCATION`,`PREFFERED_LOCATION`,`REGISTRATION_ID`,`RESUME_TITLE`,`ROLE`,`SALARY`,`ZIP`,`DATE_OF_BIRTH`,`GENDER`,`EXPERIENCE`,`MARITAL_STATUS`,`PHONE`) values (1,NULL,'ghfghf','indorewala','jj','indore','delhi',1,'deepak','managere','100000','cghfgh','09/09/2015','Male','12','single','8982198449');
