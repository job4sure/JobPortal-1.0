...
<body>
	<div id="main">
		...
		<div id="menu" class="box">
			<ul class="box">
				<li id="menu-active"><a href="showAdminHomePage"><span>HOME</span></a> <sec:authorize access="hasRole('ADMIN')">
						<li id="menu-active"><a href="addSubAdmin"><span>Add Sub Admin</span></a>
					</sec:authorize>
				<li id="menu-active"><a href="javascript:void(0);"><span>Show Job Description</span></a>
					<ul class="sub-menu">
				...
				<sec:authorize access="hasRole('ADMIN')">
					...
					<li id="menu-active"><a href="javascript:void(0);"><span>Group Mailing</span></a>
						<ul class="sub-menu">
							...
							<li><a href="groupMailToUsers">To Job Seekers</a></li>
						</ul></li>
				</sec:authorize>
			</ul>
		</div>
