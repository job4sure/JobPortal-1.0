  ...
  <h5 style="color: red;">${status}</h5>
	...
	<form:form action="" method="POST" id="formID" onsubmit="return jQuery(this).validationEngine('validate');"
		...
		<table width="100%" >
			...
			<tr>
				<td>Job Title</td>
				<td><form:input path="jobTitle" class="validate[required] input-text" size="30" disabled="true"/>
					<div id="error">
			...
			<tr>
				...
				<td><form:textarea path="jobDesc" class="validate[required] input-text" cols="50" rows="5" disabled="true"/>
					<div id="error">
			...
			<tr>
				<td>Job Location</td>
				<td><form:input path="jobLocation" class="validate[required,custom[onlyLetterSp]] input-text allmydiv" size="30" disabled="true"/>
					<div id="error">
			...
			<tr>
				<td>Salary</td>
				<td><form:input path="salary" size="10" class="validate[required] input-text" disabled="true"/></td>
			</tr>
			<tr>
				<td>Experience</td>
			...
			<tr>
				<td>Job Role</td>
				<td><form:input path="role" size="20" class="validate[required] input-text"  disabled="true"/>
					<div id="error">
			...
			<tr>
				...
				<td><form:input path="noOfCandidates" size="5" class="validate[required] input-text" disabled="true"/>
					<div id="error">
			...
			<tr>
				...
				<td><form:input path="jobValidDate" class="validate[required] input-text" disabled="true"/>
					<div id="error">
			...
			<!-- <tr>
				<td colspan="2" align="center"><input type="submit"
					value="Approve"  onclick="jQuery('#formID').submit();" />
					<input type="button"
					value="Reject"  onclick="clearAllErrors();" /></td>
