 ...
 ${message}
			<form:form method="POST" action="saveRegistration"
				...
				<div id="DivFree">
					<table class="nostyle">
						<tr>
							<td style="width: 150px;"><label id="adminname">Full
									Name*:</label></td>
							...
							<form:hidden path="validUpTo" />
							<form:hidden path="encrypted" />
						</tr>
						<tr>
							<td></td>
							<td></td>
						...
						<tr>
							<td><label id="mobileNo">Mobile Number.*:</label><label
