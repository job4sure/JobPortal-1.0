...
function searchByName(){
	 ...
	 $("#toMailId"+${employer.registrationId}).hide();
   </c:forEach>  
 ...
 textValue=textValue.toLowerCase();
  ...
  i=0;
 if(status==0){
	 $("#toMailId"+${employer.registrationId}).show();
 }
    </c:forEach>  
}
				...
				<div id="content" class="box">
					...
					<div id="content" class="box">
						...
						<div style="width: 100%; height: 200px; overflow: scroll;">
							...
							<c:forEach items="${employers}" var="employer">
								<div id="toMailId${employer.registrationId}">
									<form:checkbox path="toMailId" value="${employer.email}" />
									<label><b>Name:</b> ${employer.fullName} &nbsp;&nbsp; <b>Email Id:</b> ${employer.email}</label> <br>
								</div>
							</c:forEach>
						</div>
					</div>
