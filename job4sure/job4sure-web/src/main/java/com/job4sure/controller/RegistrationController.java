...
public class RegistrationController {
	...
	private String saveUserInformation(@ModelAttribute("Registration") Registration registration,ModelMap model,BindingResult result) throws Exception {
	...
	public String verifyUser(@RequestParam(required = false) String registrationId) throws Exception {
		String autoGeneratedPassword = AutoGenratedPassword.decrypt(registrationId);
		Integer regId = Integer.parseInt(autoGeneratedPassword);
		registrationService.verifyUser(regId);
		return "redirect:/OpenloginPage.do";
	}
}
