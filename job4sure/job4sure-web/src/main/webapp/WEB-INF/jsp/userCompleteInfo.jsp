...
<script type="text/javascript" src="resources/js/jsp/userCompleteInfo.js"></script>
<link rel="stylesheet" href="resources/css/jsp/userCompleteInfo.css" type="text/css" />
								...
								<center>
									<table width="100%" class="nostyle" style="border-collapse: separate; border-spacing: 5px">
										...
										<tr>
											...
											<td><form:select path="roletype" id="roletype" style="height:25px;  width:158px;"
													class="validate[funcCall[ifRoleTypeNotSelected]]">
										...
										<tr>
											...
											<td><form:select path="currentCityId.state.stateId" id="currentState"
													class="validate[funcCall[ifCurrentStateTypeNotSelected]]" onchange="getCityList(this)"
											...
											<td><form:select path="currentCityId.id" id="currentStateCity"
													class="validate[funcCall[ifCurrentStateCityTypeNotSelected]]" style="height:25px; width:158px;">
											...
											<td><input type="file" name="upload" id="imageUpload" onchange="previewImagepic(this)" accept="image/*"
												multiple="multiple" />
										...
										<tr>
											...
											<td style="padding: 15;">State<font color="red">*</font></td>
											<td width="50%"><form:select path="cityId.state.stateId" onchange="getCityList(this)"
													style="height:25px;  width:158px;" id="preferredState"
													class="validate[funcCall[ifPreferredStateTypeNotSelected]]">
													<option value="0">Select</option>
													<c:forEach items="${stateList}" var="state">
														<form:option value="${state.stateId}">${state.stateName}</form:option>
													</c:forEach>
											...
											<td width="50%"><form:select path="cityId.id" id="preferredStateCity"
													class="validate[funcCall[ifPreferredStateCityTypeNotSelected]]" style="height:25px;  width:158px;">
													<form:option value="0" label="Select City" />
										...
										<tr>
											...
											<td><a href="downloadResume?registrationId=${registration.registrationId}">Download resume</a></td>
										</tr>
										<tr>
								...
								<table width="100%" class="nostyle" style="border-collapse: separate; border-spacing: 5px">
									<div width="41%" valign="right">
										<tr>
											...
											<td>
												<form>
													<form:input path="dob" id="datepicker" style="height:25px;" class="validate[required] input-text" />
												</form>
											</td>
										</tr>
										<tr>
											<td style="padding: 15;">Gender<font color="red">*</font></td>
											<td><form:radiobutton path="gender" value="Male" class="validate[funcCall[ifGenderNotSelected]]" />Male
										...
										<tr>
											...
											<td><form:radiobutton path="maritalstatus" value="single"
													class="validate[funcCall[ifMaritalStatusNotSelected]]" />Single <form:radiobutton path="maritalstatus"
										...
										<tr>
											...
											<td><form:input type="text" size="40" path="phone"
													class="validate[required,custom[phone],minSize[10],maxSize[10]] input-text" maxlength="10" /><br></td>
										</tr>
										<tr>
										...
										<tr>
											...
											<td width="50%"><form:select path="homeCity.state.stateId" id="homeState"
													class="validate[funcCall[ifHomeStateNotSelected]]" onchange="getCityList(this)"
													style="height:25px;  width:158px;">
													<option value="0">select</option>
													<c:forEach items="${stateList}" var="state">
														<form:option value="${state.stateId}">${state.stateName}</form:option>
											...
											<td style="padding: 15;">City<font color="red">*</font>
											<td width="50%"><form:select path="homeCity.id" id="homeStateCity"
													class="validate[funcCall[ifHomeStateCityNotSelected]]" style="height:25px;  width:158px;">
													<option value="0">select</option>
