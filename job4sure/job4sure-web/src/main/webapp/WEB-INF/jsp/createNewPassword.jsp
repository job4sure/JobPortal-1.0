	...
	<div id="cols" class="box">
		...
		<div id="content" class="box">
			<fieldset>
				...
				<div class="msg">
					<label id="passMissMatch"></label>
				</div>
				<form:form method="POST" action="updatePassword" modelAttribute="registration" id="formID"
					onsubmit="return jQuery(this).validationEngine('validate');">
					<form:hidden path="registrationId" />
					<table class="nostyle">
						<tr>
							<td>New Password:</td>
							<td><form:password size="40" path="password" id="password"
									class="validate[required,minSize[5],maxSize[12]] input-text" maxlength="80" /></td>
						</tr>
						<tr>
