...
<body>
	<div id="main">
		...
		<div id="cols" class="box">
			...
			<hr class="noscreen" />
			<div id="content" class="box">
				<form:form method="POST" action="saveRegistration" modelAttribute="Registration" id="formID"
					onsubmit="return jQuery(this).validationEngine('validate');">
					<p>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</p>
					<form:hidden path="registrationId" />
					<p>
						<input type="radio" name="roleType" value="1" checked />Jobseeker &nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <input
							type="radio" name="roleType" value="2" />Employer
					</p>
					<div id="DivFree">
						<table class="nostyle">
							<tr>
								<td style="width: 150px;"><label id="username">Full Name*:</label><label id="companyname"
									style="display: none;">Employee Name*:</label></td>
								<td><form:input type="text" size="40" path="fullName" class="validate[required] input-text" maxlength="80"
										id="fullName" /></td>
							</tr>
							<tr>
								<td></td>
							...
							<tr>
								<td><label id="useremail">User Email*:</label><label id="companyemail" style="display: none;">Employee
										Email*:</label></td>
								<td><form:input type="text" size="40" path="email" id="email"
										class="validate[required,custom[email],maxSize[50]] input-text" maxlength="80"
										onblur="emailVarification(this);" />&nbsp&nbsp&nbsp&nbsp<span style="color: red"><form:errors
											path="email"></form:errors></span></td>
							</tr>
							<tr>
								<td></td>
								<td></td>
							...
							<tr>
								...
								<td><form:input type="password" size="40" path="conformPassword"
										class="validate[required,equals[password]] input-text" id="cpassword" maxlength="12" />&nbsp&nbsp&nbsp&nbsp<span
							...
							<tr>
								<td><label id="mobileNo">Mobile Number.*:</label><label id="contactNo" style="display: none;">Contact
										Number.*:</label></td>
								<td><form:input type="text" size="40" path="mobileNo"
										class="validate[required,custom[phone],minSize[10],maxSize[10]] input-text" maxlength="10" id="mobileNo" />&nbsp&nbsp&nbsp&nbsp<span
