...
#bar {
	...
	background: -moz-linear-gradient(top, rgba(255, 197, 120, 1) 0%,
		rgba(244, 128, 38, 1) 100%);
	background: -webkit-gradient(linear, left top, left bottom, color-stop(0%, rgba(255,
		197, 120, 1)), color-stop(100%, rgba(244, 128, 38, 1)));
	background: -webkit-linear-gradient(top, rgba(255, 197, 120, 1) 0%,
		rgba(244, 128, 38, 1) 100%);
	background: -o-linear-gradient(top, rgba(255, 197, 120, 1) 0%,
		rgba(244, 128, 38, 1) 100%);
	background: -ms-linear-gradient(top, rgba(255, 197, 120, 1) 0%,
		rgba(244, 128, 38, 1) 100%);
	background: linear-gradient(top, rgba(255, 197, 120, 1) 0%,
		rgba(244, 128, 38, 1) 100%);
	...
	<div id="main">
		<div id="cols" class="box">
			...
			<div>
				...
				<div class="wrapper">
					<div class="column">
						<b>Resume Headline:&nbsp;&nbsp;</b>${userProfile.resume}<br>
						<br> <b>Email:&nbsp;&nbsp;</b>${loggedInEmail}<br>
						<br> <b>Current Location:&nbsp;&nbsp;</b>${userProfile.currentlocation}<br>
						<%-- <br> <b>Preferred Location:&nbsp;&nbsp;</b>${userProfile.prefferedlocation}<br> --%>
						<br> <b>Preferred Industry:&nbsp;&nbsp;</b>${userProfile.industry}<br>
						<br> <b>Role:&nbsp;&nbsp;</b>${userProfile.roletype}<br>
						<br> <b>Annual Salary:&nbsp;&nbsp;</b>${userProfile.minSalary.salary}<br>
						<br> <b>Phone:&nbsp;&nbsp;</b>${userProfile.phone}<br>
						<br>
					</div>
					<div class="column">
						<b>Date of Birth:&nbsp;&nbsp;</b>${userProfile.dob}<br>
						<br> <b>Gender:&nbsp;&nbsp;</b>${userProfile.gender}<br>
						<br> <b>Marital Status:&nbsp;&nbsp;</b>${userProfile.maritalstatus}<br>
						<br> <b>Permanent Address:&nbsp;&nbsp;</b>${userProfile.address}<br>
						<br> <b>Hometown/City:&nbsp;&nbsp;</b>${userProfile.city}<br>
						<br> <b>Zip:&nbsp;&nbsp;</b>${userProfile.zip}<br>
						<br> <b>State:&nbsp;&nbsp;</b>${userProfile.state}<br>
						<br> <b>Total Experience: &nbsp;&nbsp;</b>${userProfile.minExperience.experience}<br>
						<br>
					</div>
