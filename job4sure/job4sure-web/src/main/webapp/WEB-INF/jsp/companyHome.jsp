			...
			<c:if test="${companyProfile.registrationId !=null}">
				...
				<div class="wrapper">
					<div class="column">
						...
						<b>Address:&nbsp;&nbsp;</b> ${companyProfile.address1}<br /> <br />
						<b>City:&nbsp;&nbsp;</b> ${companyProfile.city}<br /> <br /> <b>State:&nbsp;&nbsp;</b>
						${companyProfile.state}<br /> <br /> <b>About
							Us:&nbsp;&nbsp;</b> ${companyProfile.aboutUs}<br /> <br />
					</div>
					<div class="column">
						<b>No of Employee:&nbsp;&nbsp;</b> ${companyProfile.companySize}<br />
						<br /> <b>Company URL:&nbsp;&nbsp;</b>
						${companyProfile.companyUrl}<br /> <br /> <b>Zip:&nbsp;&nbsp;</b>
						${companyProfile.zipcode}<br /> <br /> <b>Domain:&nbsp;&nbsp;</b>
